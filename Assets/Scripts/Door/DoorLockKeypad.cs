...
public class DoorLockKeypad : MonoBehaviour
{
    ...
    private IEnumerator SuccessRoutine()
    {
        ...
        {
            TransientDebugConsoleUI.LogWarning($"DoorLockKeypad on '{name}': doorController is not assigned.");
        }
    ...
    private void EnsureCanvasCanReceiveClicks()
    {
        ...
        {
            TransientDebugConsoleUI.LogWarning("DoorLockKeypad: no enabled camera found for world-space canvas event camera.");
        }
    }
}