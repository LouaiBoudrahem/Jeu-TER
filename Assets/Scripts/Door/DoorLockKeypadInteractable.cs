...
public class DoorLockKeypadInteractable : MonoBehaviour, IInteractable
{
    ...
    public void Interact()
    {
        ...
        {
            TransientDebugConsoleUI.LogWarning("DoorLockKeypadInteractable.Interact: no DoorLockKeypad found.");
            return;
        }
        ...
        if (EventSystem.current == null)
        {
            ...
            TransientDebugConsoleUI.Log("DoorLockKeypadInteractable: created EventSystem with InputSystemUIInputModule for keypad UI input.");
        }
